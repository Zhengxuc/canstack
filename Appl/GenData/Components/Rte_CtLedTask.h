...
#  define Rte_Read_CtLedTask_RearLedftWindow_Position_u8_Signal(data) (Com_ReceiveSignal(ComConf_ComSignal_sig_RearLeftWindow_Position_omsg_Receive2_oCAN00_d591b374_Rx, (data))) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_RearRightWindow_Position_u8_Signal Rte_Read_CtLedTask_RearRightWindow_Position_u8_Signal
#  define Rte_Read_CtLedTask_RearRightWindow_Position_u8_Signal(data) (Com_ReceiveSignal(ComConf_ComSignal_sig_RearRightWindow_Position_omsg_Receive2_oCAN00_125b9849_Rx, (data))) /* PRQA S 3453 */ /* MD_MSR_19.7 */
