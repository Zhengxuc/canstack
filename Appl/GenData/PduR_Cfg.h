...
#define PduRConf_PduRDestPdu_msg_MyRecive_oCAN00_e0a7405f_Rx_17dd81b8_Rx 0u
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRSrcPdu_PduRSrcPdu_17dd81b8                       0u
...
#define PduRConf_PduRSrcPdu_PduRSrcPdu_b0703eaf                       1u
...
#define PduRConf_PduRDestPdu_msg_MyTransmit_oCAN00_e8f7eb32_Tx        1u
