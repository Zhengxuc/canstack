...
FUNC(Std_ReturnType, RTE_CODE) Rte_Start(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  (void)SetRelAlarm(Rte_Al_TE_PWLTask_PWL_10msRunnable, RTE_MSEC_SystemTimer(0) + (TickType)1, RTE_MSEC_SystemTimer(10)); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Stop(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  (void)CancelAlarm(Rte_Al_TE_PWLTask_PWL_10msRunnable); /* PRQA S 3417 */ /* MD_Rte_Os */
...
TASK(OsTask_APP) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  ...
  for(;;)
  {
    (void)WaitEvent(Rte_Ev_Run_Cdd_SBC_UJA1169_Sbc_Test_Runnable | Rte_Ev_Run_CpLedTask_LedRunnable | Rte_Ev_Run_PWLTask_PWL_10msRunnable); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(OsTask_APP, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_Run_Cdd_SBC_UJA1169_Sbc_Test_Runnable | Rte_Ev_Run_CpLedTask_LedRunnable | Rte_Ev_Run_PWLTask_PWL_10msRunnable)); /* PRQA S 3417 */ /* MD_Rte_Os */
    ...
    if ((ev & Rte_Ev_Run_PWLTask_PWL_10msRunnable) != (EventMaskType)0)
    {
      /* call runnable */
      PWL_10msRunnable();
    }
