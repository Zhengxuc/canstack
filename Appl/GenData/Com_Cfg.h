 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Cfg.h
 *   Generation Time: 2026-06-24 11:18:53
...
#define ComConf_ComSignal_sig_RearLeftWindow_Position_omsg_Receive2_oCAN00_d591b374_Rx 0u
#define ComConf_ComSignal_sig_RearRightWindow_Position_omsg_Receive2_oCAN00_125b9849_Rx 1u
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComGroupSignal_MyECUGroupSignal                       0u
#define ComConf_ComGroupSignal_MyECUGroupSignal_1                     1u
#define ComConf_ComSignal_RearLeft_Window                             2u
#define ComConf_ComSignal_RearRight_Window                            3u
#define ComConf_ComSignal_sig_FrontInterLight_omsg_Transmit2_oCAN00_72e0ad73_Tx 4u
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignalGroup_MyECUSignalGroup                       0u
/**\} */
...
#define Com_GetSizeOfTxBufferOfPCConfig()                             36u  /**< the number of accomplishable value elements in Com_TxBuffer */
...
#define Com_GetTxBufferEndIdxOfTxSigGrpInfo(Index)                    ((Com_TxBufferEndIdxOfTxSigGrpInfoType)((((Com_TxBufferEndIdxOfTxSigGrpInfoType)(Index)) + 36u)))  /**< the end index of the 0:n relation pointing to Com_TxBuffer */
...
#define Com_GetTxBufferSigGrpInTxIPDUEndIdxOfTxSigGrpInfo(Index)      ((Com_TxBufferSigGrpInTxIPDUEndIdxOfTxSigGrpInfoType)((((Com_TxBufferSigGrpInTxIPDUEndIdxOfTxSigGrpInfoType)(Index)) + 29u)))  /**< the end index of the 1:n relation pointing to Com_TxBuffer */
...
#define Com_GetTxBufferSigGrpInTxIPDUStartIdxOfTxSigGrpInfo(Index)    ((Com_TxBufferSigGrpInTxIPDUStartIdxOfTxSigGrpInfoType)((((Com_TxBufferSigGrpInTxIPDUStartIdxOfTxSigGrpInfoType)(Index)) + 25u)))  /**< the start index of the 1:n relation pointing to Com_TxBuffer */
#define Com_GetTxBufferStartIdxOfTxSigGrpInfo(Index)                  ((Com_TxBufferStartIdxOfTxSigGrpInfoType)((((Com_TxBufferStartIdxOfTxSigGrpInfoType)(Index)) + 32u)))  /**< the start index of the 0:n relation pointing to Com_TxBuffer */
...
#define Com_IsTriggeredOfTxSigInfo(Index)                             (((boolean)(Com_GetBitPositionOfTxSigInfo(Index) == 1u)) != FALSE)  /**< TRUE if signal or group signal has any 'TRIGGERED_*' transfer property. */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_TxBufferType, COM_VAR_NOINIT) Com_TxBuffer[36];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
