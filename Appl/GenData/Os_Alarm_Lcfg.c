 ...
 *   Generation Time: 2024-06-28 16:29:21
...
/*! Dynamic alarm data: Rte_Al_TE_PWLTask_PWL_10msRunnable */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE_PWLTask_PWL_10msRunnable_Dyn;
...
/*! Alarm configuration data: Rte_Al_TE_PWLTask_PWL_10msRunnable */
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_PWLTask_PWL_10msRunnable =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE_PWLTask_PWL_10msRunnable_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERPIT_2_COUNTER(OsCfg_Counter_SystemTimer),
      /* .Callback = */ Os_AlarmActionSetEvent
    },
    /* .Autostart             = */
  ...
  /* .Task  = */ &OsCfg_Task_OsTask_APP,
  /* .Mask  = */ Rte_Ev_Run_PWLTask_PWL_10msRunnable
};
...
CONSTP2CONST(Os_AlarmConfigType, OS_CONST, OS_CONST) OsCfg_AlarmRefs[OS_ALARMID_COUNT + 1] =
{
  ...
  OS_ALARM_CASTCONFIG_ALARMSETEVENT_2_ALARM(OsCfg_Alarm_Rte_Al_TE_PWLTask_PWL_10msRunnable),
  NULL_PTR
};
